...
Module Module1
    ...
    Sub Main()
        ...
        Dim ws = p.Workbook.Worksheets.Add($"Test V7 - {DateTime.Now.ToShortDateString()}")
        ...
        Dim path = IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Desktop), $"Test V7 - {DateTime.Now:yyyy-MM-dd}.xlsx")
