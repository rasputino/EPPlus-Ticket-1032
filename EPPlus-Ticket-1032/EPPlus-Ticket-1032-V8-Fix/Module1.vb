...
Module Module1
    ...
    Sub Main()
        ...
        Dim ws = p.Workbook.Worksheets.Add($"Test V7 Fix - {DateTime.Now.ToShortDateString()}")

        ws.Cells(1, 1).LoadFromCollection(list, True, OfficeOpenXml.Table.TableStyles.Light7)
        ...
        Dim path = IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Desktop), $"Test V7 Fix - {DateTime.Now:yyyy-MM-dd}.xlsx")
